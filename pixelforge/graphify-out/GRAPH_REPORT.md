...
## Corpus Check
- 141 files · ~270,933 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1574 nodes · 3040 edges · 46 communities detected
- Extraction: 60% EXTRACTED · 40% INFERRED · 0% AMBIGUOUS · INFERRED: 1208 edges (avg confidence: 0.76)
...
- `get_brand_kit()` --calls--> `is_connected()`  [INFERRED]
  backend/app/brand_routes.py → backend/app/database.py
- `list_comments()` --calls--> `is_connected()`  [INFERRED]
  backend/app/comments_routes.py → backend/app/database.py
...
Cohesion: 0.03
Nodes (6): ApiService, CanvasRulersComponent, CommentsOverlay, CommentsService, ShareDialog, VersionsDialog

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (5): BackgroundPanelComponent, Editor, KeyboardService, getPlatformPreset(), ToolbarPanelComponent
...
Cohesion: 0.1
Nodes (3): CollaborationService, CommandPalette, NewProjectDialog
...
- **Why does `makeService()` connect `Community 1` to `Community 7`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `seed_templates()` connect `Community 3` to `Community 2`, `Community 14`?**
